...
public class About extends JFrame implements ActionListener{
    ...
    About(){
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("notepad_clone/icon/windows.png"));
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("notepad_clone/icon/windows.png"));
